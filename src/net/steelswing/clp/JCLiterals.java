...
/**
 * File: JCLiterals.java
 * Created on 28.12.2021, 12:56:53
 *
 * @author LWJGL2
 */
public class JCLiterals {
    ...
    public static JCTree.JCExpression stringValue(TreeMaker maker, String value) {
...
//
//        private Object getEnumValue(Class<?> type, String valueName) throws ClassNotFoundException,  NoSuchFieldException {
//            if (type.isEnum()) {
